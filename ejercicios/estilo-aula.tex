...
\newcommand{\cierre}[1]{%
  \begin{tcolorbox}[enhanced, breakable, colback=white, colframe=borde,
    ...
    {\footnotesize\sffamily\bfseries\color{apagado}\MakeUppercase{Lo que acabas de ver}}\par
...
\newcommand{\imprimirclave}{%
  \ifdocente\else
    ...
    error está en algún paso intermedio: vale mucho más encontrarlo tú que
