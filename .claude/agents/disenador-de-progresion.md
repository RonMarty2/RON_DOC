...
3. **Ritmo de modalidades:** que no se repita la misma varias veces seguidas salvo que el tema lo pida, y que cada modalidad nueva se presente con una entrada suave.
4. **Curva de dificultad:** una línea por nivel con qué sube (más datos, datos que sobran, datos que hay que conseguir, un evento).
5. **Hilos que cruzan niveles:** qué personaje, empresa o recurso vuelve, y dónde.
6. **Huecos:** lo que falta del temario o del dossier para llenar cada fila, como lista para pedirle a Ronald.
