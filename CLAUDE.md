...
- Láminas `/interes-compuesto`, `/anualidades`, `/amortizacion` y `/bonos` (Matemática Financiera): sin enlazar y fuera de buscadores hasta que Ronald las revise contra su dossier. Detalle en `bitacoras/matematica-financiera.md`.
