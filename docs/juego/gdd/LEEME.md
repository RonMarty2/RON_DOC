...
**Orden de trabajo:** visión → bucle → aprendizaje → mundo → progresión de cada materia. La crítica
revisa cada parte antes de llevarla a Ronald. Una parte cambia cuando Ronald decide; cada archivo
